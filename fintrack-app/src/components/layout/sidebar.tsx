...
export default function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex items-center h-16 shrink-0 border-b border-border transition-all",
      ...
      >
        {!isCollapsed ? (
          <div className="flex items-center gap-2.5 overflow-hidden">
            ...
            <span className="font-semibold text-lg tracking-tight text-card-foreground truncate">
              MoneyFlow
            </span>
          </div>
        ) : (
      ...
      <div className="px-3 py-4 space-y-4 flex-1 flex flex-col">
        ...
        {!isCollapsed && (
          <Button
            variant="outline"
            className="w-full justify-between border-border/60 hover:bg-accent/50 hover:text-accent-foreground"
          ...
          >
            ...
            <kbd className="hidden sm:flex h-5 items-center rounded border border-border bg-muted px-1.5 text-[10px] text-muted-foreground">
              ⌘K
            </kbd>
          </Button>
        )}

        {/* Notifications Button (Mobile only - desktop has top bar) */}
        {isCollapsed && (
      ...
      <div
        className={cn(
          "mt-auto p-4 transition-all relative",
              ...
              <TooltipTrigger asChild>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <Avatar
                      className={cn(
                        "border border-border shrink-0 transition-all",
